...
namespace obamaExperimentingV1_12
{
    class Program
    {
        ...
        private static VBO<Vector3>[] cube = new VBO<Vector3>[100];
        private static VBO<Vector2>[] cubeUV = new VBO<Vector2>[100];
        ...
        private static void OnRenderFrame()
        {
            ...
            Gl.BindBufferToShaderAttribute(cube[0], program, "vertexPosition");
            Gl.BindBufferToShaderAttribute(cubeUV[0], program, "vertexUV");
